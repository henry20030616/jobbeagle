  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 sm:py-8 space-y-4">
        <div className="rounded-xl border border-indigo-500/30 bg-indigo-500/10 px-4 py-3 flex flex-wrap items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-indigo-200/70 mt-0.5">
              Fictional candidate & role for product preview — not saved to your account, no credits used.
            </p>
          </div>
          <Link
            href="/"
