...
type FT = {
  ...
  errorMsg: string; privacy: string; terms: string; expandHint: string;
};
const translations: Record<AppLanguage, FT> = {
  'zh-TW': { contactTitle: '留言給作者', contactDesc: '有任何建議或問題，歡迎直接留言，我會看到！', namePlaceholder: '您的稱呼（選填）', emailPlaceholder: '您的信箱（方便我回覆，選填）', messagePlaceholder: '輸入留言內容…', send: '送出留言', sending: '送出中…', successTitle: '留言已送出！', successDesc: '謝謝您的回饋，我會盡快查看。', errorMsg: '送出失敗，請稍後再試。', privacy: '隱私權政策', terms: '服務條款', expandHint: '點擊展開留言' },
  'zh-CN': { contactTitle: '留言给作者', contactDesc: '有任何建议或问题，欢迎直接留言，我会看到！', namePlaceholder: '您的称呼（选填）', emailPlaceholder: '您的邮箱（方便我回复，选填）', messagePlaceholder: '输入留言内容…', send: '发送留言', sending: '发送中…', successTitle: '留言已发送！', successDesc: '感谢您的反馈，我会尽快查看。', errorMsg: '发送失败，请稍后再试。', privacy: '隐私权政策', terms: '服务条款', expandHint: '点击展开留言' },
