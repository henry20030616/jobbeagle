...
type FT = { contactTitle: string; contactDesc: string; namePlaceholder: string; emailPlaceholder: string; messagePlaceholder: string; send: string; sending: string; successTitle: string; successDesc: string; errorMsg: string };
const translations: Record<AppLanguage, FT> = {
  'zh-TW': { contactTitle: '留言給作者', contactDesc: '有任何建議或問題，歡迎直接留言，我會看到！', namePlaceholder: '您的稱呼（選填）', emailPlaceholder: '您的信箱（方便我回覆，選填）', messagePlaceholder: '輸入留言內容…', send: '送出留言', sending: '送出中…', successTitle: '留言已送出！', successDesc: '謝謝您的回饋，我會盡快查看。', errorMsg: '送出失敗，請稍後再試。' },
  'zh-CN': { contactTitle: '留言给作者', contactDesc: '有任何建议或问题，欢迎直接留言，我会看到！', namePlaceholder: '您的称呼（选填）', emailPlaceholder: '您的邮箱（方便我回复，选填）', messagePlaceholder: '输入留言内容…', send: '发送留言', sending: '发送中…', successTitle: '留言已发送！', successDesc: '感谢您的反馈，我会尽快查看。', errorMsg: '发送失败，请稍后再试。' },
  ...
  hi:      { contactTitle: 'लेखक को संदेश', contactDesc: 'सुझाव या प्रतिक्रिया है? संदेश छोड़ें—मैं सभी पढ़ता हूँ!', namePlaceholder: 'आपका नाम (वैकल्पिक)', emailPlaceholder: 'आपका ईमेल (उत्तर के लिए, वैकल्पिक)', messagePlaceholder: 'अपना संदेश लिखें…', send: 'संदेश भेजें', sending: 'भेज रहे हैं…', successTitle: 'संदेश भेजा गया!', successDesc: 'आपकी प्रतिक्रिया के लिए धन्यवाद। मैं जल्द जांचूंगा।', errorMsg: 'भेजने में विफल। कृपया बाद में पुनः प्रयास करें।' },
  fr:      { contactTitle: "Message à l'Auteur", contactDesc: 'Des suggestions ? Laissez un message—je les lis tous !', namePlaceholder: 'Votre nom (facultatif)', emailPlaceholder: 'Votre email pour répondre (facultatif)', messagePlaceholder: 'Écrivez votre message…', send: 'Envoyer le Message', sending: 'Envoi en cours…', successTitle: 'Message envoyé !', successDesc: 'Merci pour vos retours. Je vérifierai bientôt.', errorMsg: "Échec de l'envoi. Veuillez réessayer plus tard." },
};
