...
export default function ReportCompareModal({
  ...
  const triggerClass =
    variant === 'button'
      ...
      : variant === 'panel'
        ? `flex w-full min-h-0 flex-1 items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-600 bg-slate-900/30 px-3.5 py-3 text-base font-semibold text-slate-100 transition hover:border-slate-500 hover:bg-slate-900/50 ${className}`
