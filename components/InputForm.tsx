  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="rounded-2xl border border-slate-700 bg-gradient-to-b from-slate-700/75 to-slate-700/90 shadow-xl overflow-hidden">
