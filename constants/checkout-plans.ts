...
> = {
  ...
  standard_subscription: {
    ...
    amountCents: 1999,
    labelEn: 'Standard — $19.99/mo (100 Snapshot + 10 Strategy)',
    labelZhTW: '標準版 — $19.99/月（100 Snapshot + 10 Strategy）',
    liteCredits: 100,
    fullCredits: 10,
  ...
  advanced_subscription: {
    ...
    amountCents: 3999,
    labelEn: 'Advanced — $39.99/mo (300 Snapshot + 30 Strategy)',
    labelZhTW: '高級版 — $39.99/月（300 Snapshot + 30 Strategy）',
    liteCredits: 300,
    fullCredits: 30,
