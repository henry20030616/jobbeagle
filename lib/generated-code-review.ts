...
const CLIENT_SECRET_RE =
  /\b(SUPABASE_SERVICE_ROLE_KEY|GEMINI_API_KEY|GOOGLE_GEMINI_API_KEY|LEMONSQUEEZY_API_KEY|LEMONSQUEEZY_WEBHOOK_SECRET|PADDLE_API_KEY|PADDLE_WEBHOOK_SECRET|PAYPAL_CLIENT_SECRET)\b/;
