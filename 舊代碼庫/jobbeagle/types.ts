...
export interface BasicAnalysis {
  ...
  company_trends: string; // New: Company Trends
  job_summary: string;
...
export interface MarketAnalysis {
  industry_trends: string; // New: Industry Overview & Trends
  positioning: string;
  competition_table: Competitor[]; // New: Competitive Landscape Table
...
export interface RealInterviewQuestion {
  question: string;
  job_title: string; // New: Job Title of the interview question
  year: string; // New: Year of the interview
  source_url?: string;
}
