...
import { 
  ...
  ExternalLink, Banknote, TrendingUp, Building2, Users, MessagesSquare, 
  Activity, ThumbsUp, Landmark, FileQuestion, Search, Star, Info, ListChecks,
  Sparkles, Download
} from 'lucide-react';
...
export const BeagleIcon = ({ className, color = "#475569", spotColor = "#5d4037", bellyColor = "#5d4037" }: { className?: string, color?: string, spotColor?: string, bellyColor?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Magnifying Glass - Arm line removed as requested */}
...
const AnalysisDashboard: React.FC<DashboardProps> = ({ data }) => {
  const { basic_analysis, salary_analysis, reviews_analysis, market_analysis, match_analysis, interview_preparation, references } = data;
              ...
              <div className="divide-y divide-slate-700">
                {interview_preparation.questions.map((q, idx) => (
                  <div key={idx} className="p-6 hover:bg-slate-700/30 transition-colors">
                    <div className="mb-4">
                      {/* Q header matches Section sub-header font size */}
                    ...
                    <div className="mt-3 bg-slate-900/50 p-5 rounded-xl border border-slate-700/50">
                      {/* Answer advice matches core section content font size (text-base) */}
