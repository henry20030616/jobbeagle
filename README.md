...
- **高階面試模擬與對策**：提供個人化面試準備建議，結合求職者履歷背景
- **🆕 瀏覽器插件**：一鍵抓取 104/LinkedIn 職缺，無需手動複製貼上
...
1. **安裝插件**：參考 `browser-extension/QUICKSTART.md` 安裝瀏覽器插件
2. **瀏覽職缺**：在 104 或 LinkedIn 上找到感興趣的職位
3. **一鍵抓取**：點擊插件圖示 → 「抓取職缺並分析」
4. **上傳履歷**：自動跳轉到 JobBeagle，上傳履歷即可分析
5. **查看報告**：獲得完整的職位分析報告
